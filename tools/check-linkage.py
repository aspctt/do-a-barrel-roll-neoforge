...
# JOML ships with the game and the roll maths leans on it, so it is checked alongside the game itself.
GAME = ("net/minecraft/", "net/neoforged/", "com/mojang/", "org/joml/")
